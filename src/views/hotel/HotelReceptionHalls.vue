<template>
  <div class="hotel-page">
    ...
    <div class="px-3 pb-4 mt-3">
      ...
      <!-- MODAL: Détail réservation salle de réception -->
      <div v-if="detailBooking" class="modal-overlay d-flex justify-content-center align-items-center" @click.self="detailBooking = null">
        <div class="bg-white rounded shadow-lg p-4" style="max-width: 560px; width: 95%; max-height: 90vh; overflow-y: auto;">
          <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
            <h5 class="mb-0"><i class="bi bi-balloon-heart me-2 text-primary"></i>Détail de la réservation</h5>
          ...
          <div class="row g-3">
            <div class="col-12">
              <div class="d-flex align-items-center gap-2">
                ...
                <span class="text-muted small">Salle : <strong>{{ detailBooking.reception_hall?.name }}</strong></span>
              </div>
            </div>
            <div class="col-md-6">
